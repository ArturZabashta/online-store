    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
          patterns: [
            ...
            to: path.resolve(__dirname, './dist/assets')},            
            {from: path.resolve(__dirname, './src/public/MSlogo.svg'),
            to: path.resolve(__dirname, './dist/assets')},            
            {from: path.resolve(__dirname, './src/public/visa.svg'),
            to: path.resolve(__dirname, './dist/assets')},            
            {from: path.resolve(__dirname, './src/public/MIrlogo.svg'),
            to: path.resolve(__dirname, './dist/assets')},            
            {from: path.resolve(__dirname, './src/public/UnionPaylogo.svg'),
            to: path.resolve(__dirname, './dist/assets')},            
            {from: path.resolve(__dirname, './src/public/cardlogo.png'),
            to: path.resolve(__dirname, './dist/assets')},            
          ], 
        }),
